            ...
            <div className="space-y-4">
              ...
              <div className="flex space-x-4">
                <a href="https://www.linkedin.com/in/sebastian-schafer-272046306/" 
                   ...
                   className="bg-gray-200/20 h-10 w-10 rounded-full flex items-center justify-center hover:bg-gray-200/30 transition-colors">
                  <svg xmlns="http://www.w3.org/2000/svg" width="20px" height="20px" fill='#fff'
                    viewBox="0 0 511 512">
                ...
                <a href="https://github.com/Sebvstiann" 
                   target="_blank" 
                   rel="noopener noreferrer"
                   className="bg-gray-200/20 h-10 w-10 rounded-full flex items-center justify-center hover:bg-gray-200/30 transition-colors">
                  <svg xmlns="http://www.w3.org/2000/svg" width="20px" height="20px" fill='#fff'
                ...
                <a href="https://wa.me/+56937018683" 
                   target="_blank" 
                   rel="noopener noreferrer"
                   className="bg-gray-200/20 h-10 w-10 rounded-full flex items-center justify-center hover:bg-gray-200/30 transition-colors">
                  <svg xmlns="http://www.w3.org/2000/svg" width="20px" height="20px" fill='#fff'
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="space-y-4">
              <input 
                ...
                placeholder='Nombre'
                className="w-full text-white bg-white/10 rounded-lg py-3 px-4 border border-gray-300/20 text-sm outline-0 focus:border-blue-500 transition-colors" 
                required
              />
              <input 
                type='email' 
            ...
            <button 
              ...
              className={`w-full text-white bg-gradient-to-r from-yellow-400 to-red-700 hover:from-yellow-500 hover:to-red-800 rounded-lg text-sm font-medium px-6 py-3 cursor-pointer border-0 transition-all duration-300 ease-out hover:scale-[1.02] ${status === 'loading' ? 'opacity-50 cursor-not-allowed' : ''}`}
            >
