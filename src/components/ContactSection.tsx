          ...
          <div className="mt-12">
            ...
            <ul className="flex mt-4 space-x-4">
              <li className="bg-gray-200/20 h-10 w-10 rounded-full flex items-center justify-center shrink-0 hover:bg-gray-200/30 transition-colors">
                <a href="https://www.linkedin.com/in/sebastian-schafer-272046306/" target="_blank" rel="noopener noreferrer">
                  <svg xmlns="http://www.w3.org/2000/svg" width="20px" height="20px" fill='#fff'
                    viewBox="0 0 511 512">
                    <path
              ...
              <li className="bg-gray-200/20 h-10 w-10 rounded-full flex items-center justify-center shrink-0 hover:bg-gray-200/30 transition-colors">
                <a href="https://github.com/Sebvstiann" target="_blank" rel="noopener noreferrer">
                  <svg xmlns="http://www.w3.org/2000/svg" width="20px" height="20px" fill='#fff'
                    viewBox="0 0 24 24">
              ...
              <li className="bg-gray-200/20 h-10 w-10 rounded-full flex items-center justify-center shrink-0 hover:bg-gray-200/30 transition-colors">
                <a href="https://wa.me/+56937018683" target="_blank" rel="noopener noreferrer">
                  <svg xmlns="http://www.w3.org/2000/svg" width="20px" height="20px" fill='#fff'
                    viewBox="0 0 24 24">
